...
face_cascade = cv2.CascadeClassifier('C:/Users/Hp/Desktop/Lock_Unlock_Using_Face_Recognition/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face

face_id = 1  # For each person,there will be one face id
count = 0    # Initialize sample face image

check_path("C:/Users\Hp\Desktop\Lock_Unlock_Using_Face_Recognition\lock_unlock_face_recognition.py")
