...
detector = cv2.CascadeClassifier("C:/Users/Hp/Desktop/Lock_Unlock_Using_Face_Recognition/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('C:/Users/Hp/Desktop/Lock_Unlock_Using_Face_Recognition/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('C:/Users/Hp/Desktop/Lock_Unlock_Using_Face_Recognition/trainer/')    # Save the model into trainer.yml
recognizer.save('C:/Users/Hp/Desktop/Lock_Unlock_Using_Face_Recognition/trainer/trainer.yml')