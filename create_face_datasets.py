...
face_cascade = cv2.CascadeClassifier('D:\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face

face_id = 1  # For each person,there will be one face id
count = 0    # Initialize sample face image

check_path("D:\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition-master\lock_unlock_face_recognition.py")
